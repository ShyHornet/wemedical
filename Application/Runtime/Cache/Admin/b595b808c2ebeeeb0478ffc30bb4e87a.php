...
<head>
    ...
    <title>微信挂号后台管理系统</title>
    <!--[if lt IE 9]>
    <meta http-equiv="refresh" content="0;ie.html" />
    <![endif]-->

    <link rel="shortcut icon" href="favicon.ico">
    <link href="/wemedical/index.php/Admin-Index/css/bootstrap.min14ed.css?v=3.3.6" rel="stylesheet">
    <link href="/wemedical/index.php/Admin-Index/css/font-awesome.min93e3.css?v=4.4.0" rel="stylesheet">
    <link href="/wemedical/index.php/Admin-Index/css/animate.min.css" rel="stylesheet">
    <link href="/wemedical/index.php/Admin-Index/css/style.min862f.css?v=4.1.0" rel="stylesheet">
</head>
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#">
                            ...
                            <span class="nav-label">医院管理</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="index_v1.html" data-index="0">医院介绍管理</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="index_v2.html">帮助信息管理</a>
                            </li>
                        </ul>

                    </li>
                    <li>
                        <a class="J_menuItem" href="docManage.html"><i class="fa fa-user-md"></i> <span class="nav-label">医生信息管理</span></a>
                    </li>
                    <li>
